...
MeetCalc ist ein statischer Meeting-Kostenrechner in purem HTML, CSS und JavaScript. Er zeigt, was ein einzelnes oder wiederkehrendes Meeting kostet, inklusive Overhead-Faktor.
...
- Overhead-Faktor: Keiner, Standard (1,3 Fach), Hoch (1,5 Fach) oder Voll (2 Fach)
